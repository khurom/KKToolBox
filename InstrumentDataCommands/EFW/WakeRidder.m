...
c_load diE4p1234;   % despun and cleaned Electric field data with Wakes
c_load WAKE4p34;    % angle location, amplitude and FWHM of wake
c_load WAKE4p12;
c_load Atwo4;
%%

Atwo4new = interp1q(Atwo4(:,1),Atwo4(:,2),diE4p1234(:,1));

Atwo4new=[diE4p1234(:,1), Atwo4new];
%%

% for i=1:1:length(WAKE4p34)

meanangle=mean(WAKE4p34(:,2))

meanWidth=1.5*mean(WAKE4p34(:,4))

meanangle=mean(WAKE4p12(:,2))

meanWidth=1.5*mean(WAKE4p12(:,4))
...
comp=2; % x component=2, y component=3, z component=4
